...
from betaVAE_model import Encoder_MNIST,Decoder_MNIST,Encoder_3Dchairs,Decoder_3Dchairs
from betaVAE_show import showimg,travel_img_showimg
from betaVAE_solver import Solver
...
if __name__ == "__main__":
	# local dir
	betaVAE_result_path_local = 'E:/pytorch_betaVAE_result/'
	data_dir_local = {'MNIST':'E:/DATA/MNIST/data',
					  '3Dchairs':'E:/DATA/',
					  'dsprites':'E:/DATA/'}
	result_path_all_dataset_local = {'MNIST':betaVAE_result_path_local+'MNIST/MNIST_result/',
									'3Dchairs':betaVAE_result_path_local+'3Dchairs/3Dchairs_result/',
									'dsprites':betaVAE_result_path_local+'dsprites/dsprites_result/'}

	# server dir
	betaVAE_result_path_server = '../../result/pytorch_betaVAE_result/'
	data_dir_server = {'MNIST':'../../dataset/MNIST/data',
					   '3Dchairs':'../../dataset/',
					   'dsprites':'../../dataset/'}
	result_path_all_dataset_server = {'MNIST':betaVAE_result_path_server+'MNIST/MNIST_result/',
									  '3Dchairs':betaVAE_result_path_server+'3Dchairs/3Dchairs_result/',
									  'dsprites':betaVAE_result_path_server+'dsprites/dsprites_result/'}
	...
	parser.add_argument('--datasetname', default='dsprites', type=str, help='dataset name')
	...
	# train
	parser.add_argument('--beta_weight', default=10, type=int, help='beta weight')
